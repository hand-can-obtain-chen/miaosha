...
import com.ptb.miaosha.controller.viewobject.UserVO;
...
public class UserController extends BaseController{
    ...
    @Autowired
    private HttpServletRequest httpServletRequest;//本质是一个proxy，内部拥有threadLocal方式的map，去让用户在每个线程当中处理他自己对应的request，并且有threadLocal清除的机制，这个httpServletRequest就是当前用户对应的http请求
